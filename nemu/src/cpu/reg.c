...
void* regp[] = {
  [0] = NULL,
  [880 /* REG_NAME_HASH("eax") */] = &cpu.eax,
  [882 /* REG_NAME_HASH("ecx") */] = &cpu.ecx,
  [883 /* REG_NAME_HASH("edx") */] = &cpu.edx,
  [881 /* REG_NAME_HASH("ebx") */] = &cpu.ebx,
  [746 /* REG_NAME_HASH("esp") */] = &cpu.esp,
  [729 /* REG_NAME_HASH("ebp") */] = &cpu.ebp,
  [613 /* REG_NAME_HASH("esi") */] = &cpu.esi,
  [598 /* REG_NAME_HASH("edi") */] = &cpu.edi,
  [736 /* REG_NAME_HASH("eip") */] = &cpu.eip,
